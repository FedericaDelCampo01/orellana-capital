    ...
    <section id='why-company' className="bg-white overflow-hidden">
      <div className="container max-w-6xl mx-auto my-10 md:py-16 flex flex-col md:flex-row items-center relative md:my-20 md:space-x-20 px-4">
        <div className="px-4 md:px-0 md:w-1/2">
          <div>
            <h2 className="text-blue font-bold font-h2 mb-2 fade-up-init">Valor Añadido</h2>
            <h3 className="text-xl md:text-3xl font-bold text-dark-blue md:leading-[48px] mb-7 font-h3 fade-up-init">Por Qué Elegirnos</h3>
            ...
            <p className="text-dark-blue mt-10 mb-6 font-bold font-body fade-up-init">
              Puntos Diferenciadores:
            </p>
            {reasons.map((reason, index) => ( 
            <div className='flex flex-row justify-start items-start py-2 font-body fade-up-init' key={index}>
        ...
        <div className="pt-16 md:pt-0 flex items-center justify-center fade-up-init">
          <OptimizedImage
            src={companyPic.src}
            alt="About Us"
            width={627}
