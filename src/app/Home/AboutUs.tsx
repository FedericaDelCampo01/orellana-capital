    ...
    <section id='about-us' className="bg-white overflow-hidden">
      ...
      <div className="container max-w-6xl mx-auto md:py-16 flex flex-col md:flex-row items-center my-10 px-4 md:my-24 md:space-x-20">
        <div className="px-4 md:px-0 md:w-1/2">
          <div>
            <h3 className="text-3xl md:text-3xl font-bold text-dark-blue md:leading-[48px] mb-7">Sobre Nosotros</h3>
            <p className="text-dark-blue font-light leading-[29px] text-base mb-8">
            ...
            <p className="text-dark-blue font-light leading-[29px] text-base">
